...
return {
  ...
  -- This is what powers VxUtil's fancy-looking
      ...
      return {
        ...
        options = {
          ...
          get_element_icon = function(opts)
            return VxUtil.config.icons.ft[opts.filetype]
          end,
        },
      }
    end,
  ...
  -- statusline
  {
    ...
    opts = function()
      ...
      local icons = VxUtil.config.icons
...

  {
      ...
      picker = {
        ...
        actions = {
          ...
          toggle_cwd = function(p)
            local root = VxUtil.root({ buf = p.input.filter.current_buf, normalize = true })
    ...
    keys = {
      ...
      },
      {
        "<leader>fe",
        function()
          Snacks.explorer({ cwd = VxUtil.root() })
        end,
