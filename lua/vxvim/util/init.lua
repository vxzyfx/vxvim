...
---@class vxvim.util: LazyUtilCore
---@field config VxVimConfig
---@field ui vxvim.util.ui
---@field lsp vxvim.util.lsp
---@field root vxvim.util.root
---@field terminal vxvim.util.terminal
---@field format vxvim.util.format
---@field plugin vxvim.util.plugin
---@field extras vxvim.util.extras
---@field inject vxvim.util.inject
---@field json vxvim.util.json
---@field lualine vxvim.util.lualine
---@field mini vxvim.util.mini
---@field pick vxvim.util.pick
---@field cmp vxvim.util.cmp
local M = {}
...
function M.has_extra(extra)
  local Config = require("vxvim.config")
  local modname = "vxvim.plugins.extras." .. extra
...
for _, level in ipairs({ "info", "warn", "error" }) do
  M[level] = function(msg, opts)
    opts = opts or {}
    opts.title = opts.title or "VxVim"
