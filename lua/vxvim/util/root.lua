...
function M.detectors.lsp(buf)
  ...
  local clients = VxUtil.lsp.get_clients({ bufnr = buf })
...
function M.info()
  ...
  lines[#lines + 1] = "```"
  VxUtil.info(lines, { title = "VxUtil Roots" })
...
function M.get(opts)
  ...
  return VxUtil.is_win() and ret:gsub("/", "\\") or ret
end
