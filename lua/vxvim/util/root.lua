...
function M.detectors.lsp(buf)
  ...
  local clients = VxVim.lsp.get_clients({ bufnr = buf })
...
function M.info()
  ...
  lines[#lines + 1] = "```"
  VxVim.info(lines, { title = "VxVim Roots" })
...
function M.setup()
  vim.api.nvim_create_user_command("LazyRoot", function()
    VxVim.root.info()
  end, { desc = "VxVim roots for the current buffer" })
...
function M.get(opts)
  ...
  return VxVim.is_win() and ret:gsub("/", "\\") or ret
end
